...
class Student:
    ...
    def has_answer(self, question: Question) -> bool:
        ...
        """
        return question in self.ques_ans and\
               self.ques_ans[question].is_valid(question)
    ...
    def get_answer(self, question: Question) -> Optional[Answer]:
        ...
        """
        if question in self.ques_ans:
            return self.ques_ans[question]
        return None
